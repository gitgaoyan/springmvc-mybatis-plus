...
public class UserController extends BaseController {
    ...
    @RequestMapping("/")
    public ModelAndView index(@RequestParam("page")int page, ModelAndView modelAndView) {
        modelAndView.setViewName("index");
        //分页查询
        modelAndView.addObject("userList", userService.selectPage(new Page<User>(page, 5)).getRecords());
        //普通查询
